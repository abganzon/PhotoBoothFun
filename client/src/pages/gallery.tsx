            ...
            {savedStrips.map((strip) => (
              <div key={strip.id} className="group relative rounded-2xl overflow-hidden bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="p-4 sm:p-5">
                  <div className="flex justify-center rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-700">
                    <PhotoStrip
                      photos={strip.photos || []}
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-bold text-slate-900 dark:text-slate-100 text-lg truncate">{strip.stripName || 'Untitled'}</div>
                ...
                <div className="px-4 sm:px-5 pb-4 sm:pb-5 flex gap-2">
                  <Button 
                    ...
                    variant="default" 
                    size="sm" 
                    className="flex-1 bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700 text-white shadow-md hover:shadow-lg transition-all duration-200 gap-2"
                  >
                  ...
                  <Button 
                    ...
                    variant="outline"
                    size="sm"
                    className="w-28 text-sky-600 dark:text-sky-300 border-2 border-sky-100 hover:bg-sky-50 dark:hover:bg-slate-800 shadow-sm transition-all duration-200"
                  >
                  ...
                  <Button 
                    ...
                    variant="destructive" 
                    size="sm" 
                    className="w-10 h-10 p-0 shadow-md hover:shadow-lg transition-all duration-200"
                  >

          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                ...
                <ul className="text-gray-600 pl-5 list-disc ml-4 space-y-2">
                  <li>No sign-up required by default</li>
                  <li>Anonymous browser ID used for share links only</li>
                  <li>Gallery saved locally on your device</li>
                  <li>Optional sign-in via Clerk when enabled by the site operator</li>
                </ul>
              </div>
            </div>
          </div>
